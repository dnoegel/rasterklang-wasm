...
require_text README.md "go_js_wasm_exec"
...
require_text CHANGELOG.md "default debug trace-mask behavior"
require_text CHANGELOG.md "go_js_wasm_exec"

require_text CONTRIBUTING.md "make check"
require_text CONTRIBUTING.md "go_js_wasm_exec"
require_text CONTRIBUTING.md "GO_WASM_EXEC"
